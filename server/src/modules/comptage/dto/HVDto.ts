...
export class HVDto {
  ...
  @ApiProperty({
    ...
    example: 'PPE_211955',
    description:
      '"Site code of the site, preffixed by PRM, PDL or CARD\n' +
  ...
  @ApiProperty({
    ...
    description:
      'For each of all 288 points on the MV (HTA) we have amount of power sent between two timestamps'
  })
  ...
  @ApiProperty({
    ...
    required: false,
    example: 'A48',
    description: 'Role Code of the TSO (A48)'
  })
