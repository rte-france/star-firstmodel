...
export class OrderBySiteActivationDocumentDto {
  @ApiProperty({
    type: String,
    example: '',
    description: 'OrderBySite Id automatically generated at creation'
  })
  ...
  @ApiProperty({
    type: String,
    example: 0,
    description: 'Timezone of the order and orderBySite.'
  })
